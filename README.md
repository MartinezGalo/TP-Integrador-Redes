...
* `01_get-ticket.py`: Autenticación y obtención de Service Ticket.
* `02_get-network-device.py`: Obtención del inventario de dispositivos.
* `03_get-host.py`: Listado de hosts conectados.
* `04_tabulate.py`: Formato de salida tabular.
